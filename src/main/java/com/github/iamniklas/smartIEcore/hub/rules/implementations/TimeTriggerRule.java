...
public class TimeTriggerRule extends Rule {
    ...
    public TimeTriggerRule(String uuid, RuleCallback callback, String ruleName, RuleData ruleData, SmartIEHub programInstance) {
        super(uuid, callback, ruleName, ruleData, programInstance, RuleType.Trigger);
